...
class TestOptimizer(BaseTest):
  ...
  def test_get_edge_weight_matrix(self):
    a = bpl.LIF(2, V_rest=-60., V_th=-50., V_reset=-60., tau=20., tau_ref=5., method='exp_auto')
    b = bpl.LIF(3, V_rest=-60., V_th=-50., V_reset=-60., tau=20., tau_ref=5., method='exp_auto')
    ...
    self.assertTrue(np.array_equal(matrix, [[0., 6., 8., 0.], [0., 0., 12., 15.], [0., 0., 0., 0.], [10., 0., 0., 0.]]))
