...
class EINet_V1(bpl.Network):
  ...
  def __init__(self, scale=1.0, method='exp_auto', delay_step=None):
    ...
    self.remoteE12I2 = bpl.synapses.RemoteSynapse(
      synapse_class=bp.synapses.Exponential,
      param_dict=dict(
        pre=self.E1,
        post=self.I2,
      ...
      source_rank=0,
      target_rank=1)
    self.remoteE12I3 = bpl.synapses.RemoteSynapse(
      synapse_class=bp.synapses.Exponential,
      param_dict=dict(
        pre=self.E1,
        post=self.I3,
      ...
      source_rank=0,
      target_rank=1)
    self.remoteE12I4 = bpl.synapses.RemoteSynapse(
      synapse_class=bp.synapses.Exponential,
      param_dict=dict(
        pre=self.E1,
        post=self.I4,
      ...
      source_rank=0,
      target_rank=2)
    self.remoteE12I5 = bpl.synapses.RemoteSynapse(
      synapse_class=bp.synapses.Exponential,
      param_dict=dict(
        pre=self.E1[:100],
        post=self.I5[:100],
      ...
      source_rank=0,
      target_rank=3)
    self.remoteI42I5 = bpl.synapses.RemoteSynapse(
      synapse_class=bp.synapses.Exponential,
      param_dict=dict(
        pre=self.I4,
        post=self.I5[:100],
